...
export interface ApiCategoryCategory extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Categories configuration';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::category.category'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titleCategoriasColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    titleCategoriasColor2: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fef3c7'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiFeaturedProductFeaturedProduct extends Struct.SingleTypeSchema {
  collectionName: 'featured_products';
  info: {
    description: 'Featured Products configuration';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titleDestacadosColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    adressColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    derechosAutorColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fde68a'>;
    descripcionColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#A99958'>;
    descripcionFormColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#A99958'>;
    descripcionLogoColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#F9B61D'>;
    enlaceColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    enlacePoliticasColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fde68a'>;
    fondoFormColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#000000'>;
    hoverEnlacePoliticasColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#F9B61D'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    titleLogoColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fef3c7'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiFuenteFuente extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    display: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Cinzel'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::fuente.fuente'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sans: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.DefaultTo<'Inter'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    descripcionLogoColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    enlacesAnuncioColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    enlacesNavColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    fechaFinAnuncio: Schema.Attribute.DateTime;
    fechaInicioAnuncio: Schema.Attribute.DateTime;
    fondoAnuncioColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#000000'>;
    fondoHeaderColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#000000'>;
    fondoNavColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'rgba(0,0,0,0.8)'>;
    hoverEnlaceNav: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#F9B61D'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::header.header'> &
      Schema.Attribute.Private;
    logoText1: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Evo'>;
    logoText1Color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    logoText2: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Hance'>;
    logoText2Color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'F9B61D'>;
    menuItems: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<
        [
          {
            label: 'Plantillas dashboard';
            url: '#';
          },
          {
            label: 'Plantillas Auth';
            url: '#';
          },
          {
            label: 'Componentes de UI/UX';
            url: '#';
          },
          {
            label: 'Libros de programacion';
            url: '#';
          },
          {
      ...
      >;
    mostrarAnuncio: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    titleAnuncio: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A1Oferta especial! Obt\u00E9n un 20% de descuento en tu primera compra'>;
    titleAnuncioColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    titleNoticias: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Nuevos Lanzamientos'>;
    titleNoticiasColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    titleRubroColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD700'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titleHero: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Cargando...'>;
    titleHero2: Schema.Attribute.String & Schema.Attribute.DefaultTo<'estandar digital'>;
    titleHeroColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fef3c7'>;
    titleHeroColor2: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fef3c7'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiInicioPaginaInicioPagina extends Struct.SingleTypeSchema {
  collectionName: 'inicio_paginas';
  info: {
    displayName: 'inicioPagina';
    pluralName: 'inicio-paginas';
    singularName: 'inicio-pagina';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::inicio-pagina.inicio-pagina'> &
      Schema.Attribute.Private;
    producto_destacado: Schema.Attribute.Component<'destacados.seccion-productos', false>;
    producto_tendencia: Schema.Attribute.Component<'tendencias.producto', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiNewsletterNewsletter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::newsletter.newsletter'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtituloColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    titleColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#E4D9AF'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiProductTendenciaProductTendencia extends Struct.CollectionTypeSchema {
  collectionName: 'product_tendencias';
  info: {
    description: 'Product_tendencia collection';
    displayName: 'Product_tendencia';
    pluralName: 'product-tendencias';
    singularName: 'product-tendencia';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    categoriaProducto: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    descargasProducto: Schema.Attribute.String;
    descuentoEtiquetaProducto: Schema.Attribute.String;
    descuentoProducto: Schema.Attribute.Decimal;
    imageProducto: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    ratingEstrellasProducto: Schema.Attribute.Decimal;
    ratingProducto: Schema.Attribute.Decimal;
    reseñasProducto: Schema.Attribute.String;
    titleProducto: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiTrustBannerTrustBanner extends Struct.SingleTypeSchema {
  collectionName: 'trust_banners';
  info: {
    description: 'Trust Banner configuration';
    displayName: 'TrustBanner';
    pluralName: 'trust-banners';
    singularName: 'trust-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    descripcionConfianzaColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fde68a'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trust-banner.trust-banner'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titleConfianzaColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#fef3c7'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::inicio-pagina.inicio-pagina': ApiInicioPaginaInicioPagina;
      'api::newsletter.newsletter': ApiNewsletterNewsletter;
      'api::product-tendencia.product-tendencia': ApiProductTendenciaProductTendencia;
      'api::product.product': ApiProductProduct;
      'api::trust-banner.trust-banner': ApiTrustBannerTrustBanner;

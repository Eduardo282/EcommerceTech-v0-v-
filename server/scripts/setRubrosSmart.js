...
async function setRubrosSmart() {
  try {
    ...
    const gamingKeywords = ["Gaming", "Controller", "Arcade", "Pixel", "Royale", "Skins", "HUD", "Stream", "Twitch", "Esports", "Console", "SFX", "Map", "Pack", "Asset", "Fantasy", "RPG", "FPS", "Headset", "Soundtrack", "Arena", "Cyber"];
    const techKeywords = ["Dashboard", "UI Kit", "App", "Website", "Code", "Script", "Template", "SaaS", "Admin", "Analytics", "Mobile"];

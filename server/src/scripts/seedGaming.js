...
async function run() {
  ...
  const base = [
    ...
    { title: 'Sci‑Fi SFX Bundle', price: 15.0 },
    { title: 'Racing HUD Kit', price: 16.0 },
    { title: 'Open‑World Map Pack', price: 19.0 },
  ...
  console.log('🕹  Seeding GAMING products (non-destructive)…');
  let created = 0;
  for (let i = 0; i < base.length; i++) {
    const b = base[i];
    const doc = {
      title: b.title,
      description: 'Gaming marketplace sample product autogenerated by seedGaming.js',
      price: b.price,
  ...
  console.log(`✅ Done. Inserted ${created} new gaming products.`);

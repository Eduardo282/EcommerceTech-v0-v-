        ...
        <div className="flex flex-col h-full relative z-10">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-amber-300/70 text-sm">{items.length} artículos</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <section className="flex-1 overflow-auto scrollbar-hide p-6">
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <h3 className="text-xl mb-2 text-amber-100">Tu carrito está vacío</h3>
                <p className="text-amber-200/70 mb-6">Agrega algunos productos para comenzar.</p>
                <Button
                  onClick={onClose}
          ...
          {items.length > 0 && (
            ...
            >
              ...
              <p className="text-xs text-center text-amber-200/60 mt-4">🔒 Pago seguro</p>
            </footer>
          )}
        </div>
      </aside>

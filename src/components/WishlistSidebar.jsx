  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Wishlist"
        style={{
          background: 'linear-gradient(to bottom, rgba(12,12,16,0.95) 0%, #111115 100%)',
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 0 20px rgba(234,179,8,0.45)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = 'rgba(234,179,8,0.4)';
                e.currentTarget.style.boxShadow = '0 0 10px rgba(234,179,8,0.22)';
              }}
            >
            ...
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <Button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 35px rgba(234,179,8,0.5)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 25px rgba(234,179,8,0.35)';
                  }}
                >
                  Seguir Explorando
                </Button>
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm mb-1 line-clamp-2 text-amber-100">{item.name}</h3>
                      <p className="text-xs text-amber-200/60 mb-2">{item.category}</p>
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.boxShadow = '0 0 25px rgba(234,179,8,0.45)';
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.boxShadow = '0 0 15px rgba(234,179,8,0.28)';
                          }}
                        >
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 35px rgba(234,179,8,0.45)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 25px rgba(234,179,8,0.3)';
                  }}
                >

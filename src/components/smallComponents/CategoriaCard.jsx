      ...
      export function CategoriaCard({ category, openDropdown, setOpenDropdown, getColor }) {
       ...
       {/* Professional Tech Image Container */}
                    <div className="relative mx-auto w-40 h-40 mb-6 group-hover:-translate-y-2 transition-transform duration-500">
                      <div
                        className="absolute inset-0 rounded-2xl bg-linear-to-br from-[#F9B61D10] to-[#F9B61D10] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      />

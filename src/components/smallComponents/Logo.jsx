      ...
      <div className="relative">
        ...
        <div className="relative w-12 h-12 perspective-1000">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #F9B61D 0%, #F9B61D 100%)',
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to right, #E4D9AF 0%, #E4D9AF 100%)',
          }}
        />
        {/* Cara izquierda */}
        <div
          ...
          style={{
            background: 'linear-gradient(to bottom, #E4D9AF 0%, #E4D9AF 100%)',
          }}
        />
      </div>
    </>

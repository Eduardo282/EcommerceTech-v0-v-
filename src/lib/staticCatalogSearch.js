...
export const STATIC_CATALOG_SEARCH_ITEMS = [
  ...
  ...BOOKS_DATA.map((book) => toSearchItem(mapBookToProduct(book), '/libros-programacion', 'Libro')),
  ...GUIDES_DATA.map((guide) =>
    toSearchItem(mapGuideToProduct(guide), '/guias-estudio', 'Guía')
  ),

...
const GUIDES_DATA = [
  {
    ...
    description: "Domina patrones de diseño, hooks personalizados y optimización de rendimiento en React.",
    category: "frontend",
    level: "Avanzado",
    duration: "12h 30m",
    modules: 15,
  ...
  },
  {
    ...
    description: "Construye APIs escalables, seguras y robustas utilizando Node.js, Express y MongoDB.",
    category: "backend",
    level: "Intermedio",
    duration: "18h 15m",
    modules: 22,
  ...
  },
  {
    ...
    description: "Aprende a crear sistemas de diseño coherentes y escalables para productos digitales modernos.",
    category: "design",
    level: "Intermedio",
    duration: "10h 45m",
    modules: 12,
  ...
  },
  {
    ...
    rating: 4.7,
    students: 600,
    image: "https://images.unsplash.com/photo-1667372393119-c81c0cda0563?q=80&w=1000&auto=format&fit=crop",
      ...
      <section className="relative pt-32 pb-16 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-400 to-amber-600 drop-shadow-[0_0_15px_rgba(245,158,11,0.5)]">
              ESTUDIO
            </span>
          </h1>
          
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            Rutas de aprendizaje estructuradas para potenciar tu carrera. 
            Desde fundamentos hasta conceptos avanzados en desarrollo y diseño.
          </p>
              ...
              <div className="h-56 relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 z-20">
                  <span className={`
                    ...
                    ${guide.level === 'Avanzado' ? 'bg-red-500/20 text-red-400 border border-red-500/30' : 
                      guide.level === 'Intermedio' ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30' : 
              ...
              <div className="p-8 relative flex-1 flex flex-col">
                <div className="flex flex-wrap gap-2 mb-4">
                  {guide.tags.map((tag, i) => (
                    <span key={i} className="text-xs font-medium px-2.5 py-1 rounded-md bg-white/5 text-gray-400 border border-white/5">
                      {tag}
                    </span>
                  ))}
                </div>

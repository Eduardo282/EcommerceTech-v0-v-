...
const CATEGORIES = ["Todos", "Software Engineering", "JavaScript", "Architecture", "Career", "Computer Science"];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-amber-500/30">
        ...
        <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-6xl md:text-8xl font-black leading-tight tracking-tighter">
              READ. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-500 to-orange-600">
                CODE.
              </span> <br />
              REPEAT.
            </h1>
            ...
            <p className="text-xl text-gray-400 max-w-lg leading-relaxed border-l-4 border-amber-500 pl-6">
              La colección definitiva de libros para desarrolladores que buscan la excelencia. 
              Desde algoritmos hasta arquitectura de software.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Button variant="outline" className="h-14 px-8 rounded-full border-white/20 hover:bg-white/10 text-white font-medium text-lg backdrop-blur-sm">
                Novedades del Mes
              </Button>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative w-[400px] h-[550px] mx-auto transform rotate-[-6deg] hover:rotate-0 transition-all duration-700 ease-out group cursor-pointer">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-orange-600 rounded-xl shadow-[0_20px_50px_rgba(245,158,11,0.3)] group-hover:shadow-[0_30px_80px_rgba(245,158,11,0.5)] transition-all duration-500" />
              <img 
              ...
              />
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/90 via-black/20 to-transparent rounded-xl">
                <span className="text-amber-400 font-bold tracking-wider text-sm mb-2">LIBRO DESTACADO</span>
                <h3 className="text-3xl font-bold text-white mb-1">Designing Data-Intensive Applications</h3>
            ...
            >
              ...
              <div className="aspect-[2/3] relative overflow-hidden bg-gray-900">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3 p-4">
                  ...
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/20 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
              ...
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-xs font-medium text-amber-400 uppercase tracking-wider">{book.category}</p>
      ...
      <section className="container mx-auto px-4 mb-20">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-amber-900/40 to-orange-900/40 border border-amber-500/20">
          ...
          <div className="relative z-10 p-10 md:p-16 grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-amber-300 font-bold tracking-widest text-sm">CLUB DE LECTURA</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input 
                  ...
                  className="px-6 py-4 rounded-xl bg-black/30 border border-white/10 text-white placeholder-amber-200/50 focus:outline-none focus:ring-2 focus:ring-amber-400 flex-grow"
                />
